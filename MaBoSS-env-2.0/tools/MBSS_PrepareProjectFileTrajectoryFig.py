...
#
# Tool: MBSS_PrepareProjectFileTrajectoryFig.py
...
if sys.argv[1] == "help":
    print("MBSS_PrepareProjectFileTrajectoryFig.py takes one argument: the name of the foldername_probtraj_table.csv file")
...
maboss_probability_table = "{}_probtraj_table.csv".format(file_name)
